...
<li><a href="https://www.99chan.org/usage/">[<?php  if (!isset($_tag_stack)){ $_tag_stack = array(); } $_tag_stack[] = array(); $_block_repeat=true; smarty_block_t($_tag_stack[count($_tag_stack)-1], null, $this, $_block_repeat); while ($_block_repeat) { ob_start();?>Site Stats<?php  $_block_content = ob_get_clean(); $_block_repeat=false; echo smarty_block_t($_tag_stack[count($_tag_stack)-1], $_block_content, $this, $_block_repeat); } array_pop($_tag_stack);?>] </a> </li>
<?php 
}?>
...
/* -- foreach start output */
?>
				<li><a href="https://www.99chan.org/<?php echo $this->scope["brd"]["name"];?>/" class="boardlink<?php if ((isset($this->scope["brd"]["trial"]) ? $this->scope["brd"]["trial"]:null) == 1) {
?> trial<?php 
}
