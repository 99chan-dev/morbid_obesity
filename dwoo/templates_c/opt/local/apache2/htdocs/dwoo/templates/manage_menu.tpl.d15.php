...
?>
	...
	<?php 
$_loop1_data = (isset($this->scope["styles"]) ? $this->scope["styles"] : null);
$this->globals["loop"]['default'] = array
(
	"iteration"		=> 1,
	"last"		=> null,
	"total"		=> $this->isArray($_loop1_data) ? count($_loop1_data) : 0,
);
$_loop1_glob =& $this->globals["loop"]['default'];
if ($this->isArray($_loop1_data) === true)
{
	foreach ($_loop1_data as $tmp_key => $this->scope["-loop-"])
	{
		$_loop1_glob["last"] = (string) ($_loop1_glob["iteration"] === $_loop1_glob["total"]);
...
if (!isset($_tag_stack)){ $_tag_stack = array(); } $_tag_stack[] = array(); $_block_repeat=true; smarty_block_t($_tag_stack[count($_tag_stack)-1], null, $this, $_block_repeat); while ($_block_repeat) { ob_start();?>Styles<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo smarty_block_t($_tag_stack[count($_tag_stack)-1], $_block_content, $this, $_block_repeat); } array_pop($_tag_stack);?>:<?php $_loop2_data = (isset($this->scope["styles"]) ? $this->scope["styles"] : null);$this->globals["loop"]['default'] = array("iteration"		=> 1,"last"		=> null,"total"		=> $this->isArray($_loop2_data) ? count($_loop2_data) : 0,);$_loop2_glob =& $this->globals["loop"]['default'];if ($this->isArray($_loop2_data) === true){foreach ($_loop2_data as $tmp_key => $this->scope["-loop-"]){$_loop2_glob["last"] = (string) ($_loop2_glob["iteration"] === $_loop2_glob["total"]);$_loop2_scope = $this->setScope(array("-loop-"));/* -- loop start output */?>[<a href="#" onclick="javascript:set_stylesheet(\'<?php echo Dwoo_Plugin_capitalize($this, $this->scope, false);?>\', false, true);reloadmain();" style="display: inline;" target="_self"><?php echo mb_strtoupper((string) substr($this->scope, 0, 1), $this->charset);?></a>]<?php if (! (isset($this->globals["loop"]["default"]["last"]) ? $this->globals["loop"]["default"]["last"]:null)) {?> <?php }
/* -- loop end output */$this->setScope($_loop2_scope, true);$_loop2_glob["iteration"]+=1;}}
}?>';
...
<li><a href="<?php echo KU_CGIPATH;?>/manage.php" target="_top">[<?php  if (!isset($_tag_stack)){ $_tag_stack = array(); } $_tag_stack[] = array(); $_block_repeat=true; smarty_block_t($_tag_stack[count($_tag_stack)-1], null, $this, $_block_repeat); while ($_block_repeat) { ob_start();?>Management<?php  $_block_content = ob_get_clean(); $_block_repeat=false; echo smarty_block_t($_tag_stack[count($_tag_stack)-1], $_block_content, $this, $_block_repeat); } array_pop($_tag_stack);?>]  </a></li>
<li><a href="https://www.99chan.org/irc.html">[<?php  if (!isset($_tag_stack)){ $_tag_stack = array(); } $_tag_stack[] = array(); $_block_repeat=true; smarty_block_t($_tag_stack[count($_tag_stack)-1], null, $this, $_block_repeat); while ($_block_repeat) { ob_start();?>Internet Relay Chat<?php  $_block_content = ob_get_clean(); $_block_repeat=false; echo smarty_block_t($_tag_stack[count($_tag_stack)-1], $_block_content, $this, $_block_repeat); } array_pop($_tag_stack);?>]  </a> </li> 
<li><a href="https://www.99chan.org/phpdenora/">[<?php  if (!isset($_tag_stack)){ $_tag_stack = array(); } $_tag_stack[] = array(); $_block_repeat=true; smarty_block_t($_tag_stack[count($_tag_stack)-1], null, $this, $_block_repeat); while ($_block_repeat) { ob_start();?>IRC Stats<?php  $_block_content = ob_get_clean(); $_block_repeat=false; echo smarty_block_t($_tag_stack[count($_tag_stack)-1], $_block_content, $this, $_block_repeat); } array_pop($_tag_stack);?>]  </a>   </li>
<?php 
}?>
