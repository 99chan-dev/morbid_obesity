...
/* Post editing */
        ...
        function editpost() {
                global $tc_db, $tpl_page;
                $this->AdministratorsOnly(); /*OR $this->AdministatorsOnly(); */ /*Select whether you want this option was for modetartors or only administators */
		...
		if (!$board) {
			...
			foreach ($results as $line) {
				...
				if ($posterauthority == "1") {
					$posterauthority = "<font color=\"purple\"><strong>##Administrator##</strong></font>";
				} elseif ($posterauthority == "2") {
					$posterauthority = "<font color=\"red\"><strong>##Moderator##</strong></font>";
				} else {
					$posterauthority = "";
				}
				if ($deleted == "1") {
